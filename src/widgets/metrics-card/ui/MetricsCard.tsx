...
export function MetricsCard({ regionCode }: { regionCode: number }) {
	const { forecast } = useForecast(regionCode);
	...
	return (
		<div className="card bg-primary text-white shadow-sm h-100">
			<div className="card-body">
				<h5>
					<i className="fas fa-chart-simple"></i> Метрики качества
				</h5>
				<hr />
				<p>
				...
				<p>
					<strong>RMSE:</strong> {rmse.toLocaleString()}
				</p>
				<p>
					<strong>MAE:</strong> {mae.toLocaleString()}
				</p>
				<p>
