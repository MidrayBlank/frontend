...
export function Heatmap() {
  ...
  useEffect(() => {
    ...
    ymaps.ready(() => {
      ...
      const search = new ymaps.control.SearchControl({ options: { noPlacemark: true, useMapBounds: false } });
  ...
  return <div id="map" ref={mapRef} style={{ width: '100%', height: '500px', borderRadius: '16px' }}></div>;
}