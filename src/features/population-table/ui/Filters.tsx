...
export function Filters({
  subject, type, periodFrom, periodTo,
  onSubjectChange, onTypeChange, onPeriodFromChange, onPeriodToChange,
  onApply, onReset
}: FiltersProps) {
  return (
    <div>
      <div className="row mb-4">
        <div className="col-md-3">
          ...
          <select className="form-select" value={subject} onChange={e => onSubjectChange(e.target.value)}>
      ...
      <div className="row mb-4">
        <div className="col-md-6">
          <button className="btn w-100" style={{ background: 'var(--primary-500)', color: 'white', borderRadius: 12 }} onClick={onApply}>
            <i className="fas fa-filter me-2"></i>Применить фильтры
          </button>
        </div>
        <div className="col-md-6">
          <button className="btn w-100" style={{ background: 'var(--bg-700)', color: 'var(--text-100)', borderRadius: 12 }} onClick={onReset}>
